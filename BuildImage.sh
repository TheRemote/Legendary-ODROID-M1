...
TARGET_IMGXZ="legendary-ubuntu-${DEST_RELEASE}-server-odroidm1-${IMAGE_VERSION}.img.xz"
DESKTOP_IMG="legendary-ubuntu-${DEST_RELEASE}-desktop-odroidm1-${IMAGE_VERSION}.img"
DESKTOP_IMGXZ="legendary-ubuntu-${DEST_RELEASE}-desktop-odroidm1-${IMAGE_VERSION}.img.xz"
MATE_DESKTOP_IMG="legendary-ubuntu-${DEST_RELEASE}-mate-desktop-odroidm1-${IMAGE_VERSION}.img"
MATE_DESKTOP_IMGXZ="legendary-ubuntu-${DEST_RELEASE}-mate-desktop-odroidm1-${IMAGE_VERSION}.img.xz"
